...
Butler is a local-first productivity operating system designed as a desktop application. It integrates task management, time tracking, focus timers, journal logs, document research, and a personal knowledge graph into a unified, high-performance, offline-first workspace.
