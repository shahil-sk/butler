...
export function BentoGrid({ tasks, onOpenTask, onToggleComplete, priorityFilter, onPriorityFilter }: Props) {
  ...
  return (
    <div ref={gridRef} className="w-full max-w-7xl mx-auto px-4 md:px-8 pb-32">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 auto-rows-min gap-4 md:gap-6" style={{ gridAutoFlow: 'dense' }}>
