...
function rowToTask(r: Record<string, unknown>): Task {
  return {
    ...
    scheduledDate:    (r.scheduled_date as string | null) ?? (r.scheduled_at as string | null) ?? undefined,
    scheduledAt:      (r.scheduled_at as string | null) ?? (r.scheduled_date as string | null) ?? undefined,
